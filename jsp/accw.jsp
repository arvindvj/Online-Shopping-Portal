...
<html lang="en">
<head>
<title>SKART | WOMEN ACCESSORIES</title>
<meta charset="utf-8">
...
<div class="main">
  ...
  <div class="content">
    <div class="container_12">
      <div class="grid_7">
        <h2 class="head2">WOMEN ACCESSORIES</h2>
        
       
        <div class="news"> <img src="images/clutch.jpeg" alt="" class="img_inner fleft">
          <div class="extra_wrapper">
            <p>                                     </p>
            <div class="col1">Clutch</div>
            <form action="cart?proid=32" name="cart" method="post">
            <p><br>Rs. 1,470  </p><br>
            <input type="submit" value="ADD TO CART" onclick= "validate1()"></form></div>
        </div>
        <div class="news"> <img src="images/pendant.jpeg" alt="" class="img_inner fleft">
          <div class="extra_wrapper">
            <p>                                     </p>
            <div class="col1">Pendant</div>
            <form action="cart?proid=33" name="cart" method="post">
            <p><br>Rs. 9,470  </p><br>
            <input type="submit" value="ADD TO CART" onclick= "validate1()"></form></div>
        </div>
      ...
      <div class="grid_3 prefix_2">
        ...
        <ul class="list l1">
          ...
          <li><a href="accw.jsp">ACCESSORIES</a></li>
        </ul>
      </div>
      <div class="clear"></div>
